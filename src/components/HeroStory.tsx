...
export function HeroStory({ story }: { story: NarrativeGap }) {
  ...
  return (
    <section id="story-1">
      ...
      <div className="relative h-[55vh] min-h-[380px] overflow-hidden mx-4 md:mx-8 rounded-t-lg">
        {story.image_file ? (
      ...
      <div className="mx-4 md:mx-8 rounded-b-lg px-6 md:px-12 pb-10 pt-5" style={{ background: '#ffffff' }}>
